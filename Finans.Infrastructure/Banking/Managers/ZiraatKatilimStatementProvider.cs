...
{
    public sealed class ZiraatKatilimStatementProvider : IBankProvider
    {
        ...
        private static void ParseAccountServiceJson(string json, string? filterAccountNo, string bankCode, List<LegacyBankRow> target)
        {
